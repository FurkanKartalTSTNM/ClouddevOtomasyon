...
public class JsMethods {
    ...
    public void nzselectIleTıkla(String text){

        String script = "var element = document.evaluate(\"//*[contains(text(), '" + text + "')]\"," +
                "document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;" +
                "if (element) { element.click(); return 'clicked'; } else { return 'not found'; }";
